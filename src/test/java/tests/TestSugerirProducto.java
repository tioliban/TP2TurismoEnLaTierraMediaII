...
public class TestSugerirProducto {
	...
	public void setUp() throws Exception {
		...
		primera = new Porcentual("Primera", TipoAtraccion.AVENTURA, primeras, atracciones, 20);
		segunda = new AxB("Segunda", TipoAtraccion.AVENTURA, segundas, atracciones, bosqueNegro.getNombre());
		tercera = new Absoluta("Tercera", TipoAtraccion.DEGUSTACION, terceras, atracciones, 36);
		cuarta = new Porcentual("Cuarta", TipoAtraccion.DEGUSTACION, cuartas, atracciones, 25);
		quinta = new AxB("Quinta", TipoAtraccion.PAISAJE, quintas, atracciones, erebor.getNombre());
